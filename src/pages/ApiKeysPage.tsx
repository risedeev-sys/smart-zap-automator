...
import { Smartphone, Construction, Phone, CalendarDays, Eye, EyeOff, Settings2 } from "lucide-react";
      ...
      <div className="flex items-center justify-center min-h-[60vh]">
        <Card className="max-w-lg w-full border-dashed border-2 border-border">
          <CardHeader className="text-center pb-4">
            ...
            <CardTitle className="text-xl">Gerenciamento de Instâncias</CardTitle>
            ...
            <Card className="border border-border bg-muted/30 opacity-60 pointer-events-none select-none">
              <CardContent className="p-4 space-y-2">
                ...
                <div className="flex items-center gap-1.5 text-xs">
                  ...
                  <span className="text-emerald-500 font-medium">Chave válida (ativa)</span>
                </div>
